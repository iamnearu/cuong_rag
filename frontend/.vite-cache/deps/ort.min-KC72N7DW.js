...
var Ja = L(() => {
  ...
  Xa = (a, t) => {
    ...
    if (e != null) {
      let r, n;
      (t == null ? void 0 : t.tensorLayout) !== void 0 && t.tensorLayout === "NHWC" ? (r = a.dims[2], n = a.dims[3]) : (r = a.dims[3], n = a.dims[2]);
      let s = (t == null ? void 0 : t.format) !== void 0 ? t.format : "RGB", i = t == null ? void 0 : t.norm, u, l;
    ...
    if (o != null) {
      let r, n, s;
      (t == null ? void 0 : t.tensorLayout) !== void 0 && t.tensorLayout === "NHWC" ? (r = a.dims[2], n = a.dims[1], s = a.dims[3]) : (r = a.dims[3], n = a.dims[2], s = a.dims[1]);
      let i = t !== void 0 && t.format !== void 0 ? t.format : "RGB", u = t == null ? void 0 : t.norm, l, c;
...
function Xt(a, t, o, e) {
  ...
  if (o === void 0)
    Bn(a, t, 1);
  else if (typeof o == "number" && e === void 0)
    Bn(a, t, o);
  else if (typeof o == "string" && e === void 0)
    Bn(a, o, 1, t);
...
var tn = L(() => {
  ...
  ((t) => {
    ...
    ((e) => {
      ...
      ((n) => {
        let r;
        ((F) => (F[F.UNDEFINED = 0] = "UNDEFINED", F[F.FLOAT = 1] = "FLOAT", F[F.INT = 2] = "INT", F[F.STRING = 3] = "STRING", F[F.TENSOR = 4] = "TENSOR", F[F.GRAPH = 5] = "GRAPH", F[F.FLOATS = 6] = "FLOATS", F[F.INTS = 7] = "INTS", F[F.STRINGS = 8] = "STRINGS", F[F.TENSORS = 9] = "TENSORS", F[F.GRAPHS = 10] = "GRAPHS", F[F.SPARSE_TENSOR = 11] = "SPARSE_TENSOR", F[F.SPARSE_TENSORS = 12] = "SPARSE_TENSORS"))(r = n.AttributeType || (n.AttributeType = {}));
      })(o = e.fbs || (e.fbs = {}));
    })(a = t.experimental || (t.experimental = {}));
  })(V || (V = {}));
  ((t) => {
    let a;
    ((e) => {
  ...
  ((t) => {
    ...
    ((e) => {
      ...
      ((n) => {
        let r;
        ((c) => (c[c.NONE = 0] = "NONE", c[c.tensor_type = 1] = "tensor_type", c[c.sequence_type = 2] = "sequence_type", c[c.map_type = 3] = "map_type"))(r = n.TypeInfoValue || (n.TypeInfoValue = {}));
      })(o = e.fbs || (e.fbs = {}));
    })(a = t.experimental || (t.experimental = {}));
  })(V || (V = {}));
  ((t) => {
      ...
      function t(e, r, n, s, i, u) {
        ...
        if (l && (s = -s), s === 0)
          ...
          if (s < 22250738585072014e-324)
            c = s / 5e-324, e(c >>> 0, i, u + r), e((l << 31 | c / 4294967296) >>> 0, i, u + n);
          else {
...
var Jt = me((ei) => {
  ...
  W.pool = eu();
  W.LongBits = ru();
  W.isNode = !!(typeof globalThis < "u" && globalThis && globalThis.process && globalThis.process.versions && globalThis.process.versions.node);
  W.global = W.isNode && globalThis || typeof window < "u" && window || typeof self < "u" && self || ei;
...
`);
    ...
    bindUniforms(t, o, e) {
      ...
      for (let { name: s, type: i, location: u, arrayLength: l } of t) {
        let c = (_a = o.find((p) => p.name === s)) == null ? void 0 : _a.data;
        if (i !== "sampler2D" && !c)
  ...
  go = class {
    ...
    async readTextureAsync(t, o, e) {
      ...
      return this.profiler.event("backend", "TextureManager.readTextureAsync", async () => {
        ...
        return this.pendingRead.delete(r), u == null ? void 0 : u.forEach((l) => l(i)), i;
      });
    }
    ...
    buildGraphFromOnnxFormat(t) {
      ...
      for (let n = 0; n < this._nodes.length; n++) {
        ...
        for (let u of i.output) {
          let l = o.get(u);
          if (typeof l > "u" && (l = this._allData.push(new Mt()) - 1, o.set(u, l)), s.outputs.push(l), this._allData[l]._from !== void 0)
    ...
    buildGraphFromOrtFormat(t) {
      ...
      for (let n = 0; n < t.inputsLength(); n++) {
        ...
        for (let i = 0; i < t.nodeArgsLength(); i++)
          if (((_a = t.nodeArgs(i)) == null ? void 0 : _a.name()) === s) {
            let u = new Mt();
            if (((_c2 = (_b2 = t.nodeArgs(i)) == null ? void 0 : _b2.type()) == null ? void 0 : _c2.valueType()) !== wo.TypeInfoValue.tensor_type)
      ...
      for (let n = 0; n < this._nodes.length; n++) {
        ...
        if ((i == null ? void 0 : i.outputsLength()) === 0)
          throw new Error(`missing output for node: ${i.name}`);
        for (let u = 0; u < (i == null ? void 0 : i.outputsLength()); u++) {
          let l = i == null ? void 0 : i.outputs(u), c = o.get(l);
          if (typeof c > "u" && (c = this._allData.push(new Mt()) - 1, o.set(l, c)), s.outputs.push(c), this._allData[c]._from !== void 0)
        ...
        if (t.opType === "Conv") {
          ...
          if (o.length === 1 && this.isActivation(this._nodes[o[0]])) {
            ...
            if (e.opType === "Clip")
              ...
              else if (e.inputs.length >= 3 && this._allData[e.inputs[1]].tensor !== void 0 && this._allData[e.inputs[2]].tensor !== void 0)
...
as ORT format: ${n}`);
    ...
    loadFromOrtFormat(t, o) {
      ...
      for (let s = 0; s < r.opsetImportLength(); s++) {
        ...
        this._opsets.push({ domain: i == null ? void 0 : i.domain(), version: it.longToNumber(i.version()) });
      }
...
var Pp = me((Ap, ra) => {
  ...
  var Sp = (() => {
    var _a;
    var a = typeof document < "u" ? (_a = document.currentScript) == null ? void 0 : _a.src : void 0;
    return typeof __filename < "u" && (a || (a = __filename)), function(t = {}) {
      ...
      var tt = 0, tr = 0, ke = typeof TextDecoder < "u" ? new TextDecoder("utf8") : void 0, Be = (m, x, O) => {
        ...
        if (!nr) {
          ...
          for (x in Or)
            Or[x] === void 0 ? delete m[x] : m[x] = Or[x];
          var O = [];
          for (x in m)
            O.push(`${x}=${m[x]}`);
          nr = O;
...
var kp = me(($p, na) => {
  ...
  var Fp = (() => {
    ...
    return typeof __filename < "u" && (a || (a = __filename)), function(t = {}) {
      ...
      S && typeof performance > "u" && (globalThis.performance = Dp().performance);
...
`));
      ...
      function jr(f) {
        ...
        if (A)
          return he(0, 1, f);
        ee = f, 0 < Gt || (X.hb(), (_a3 = i.onExit) == null ? void 0 : _a3.call(i, f), et = true), T(f, new rr(f));
      }
      var Yr = (f) => {
        if (ee = f, A)
          throw _n(f), "unwind";
      ...
      var Bo = [], No = {}, Oa = () => {
        if (!Ro) {
          ...
          for (b in No)
            No[b] === void 0 ? delete f[b] : f[b] = No[b];
          var y = [];
          for (b in f)
            y.push(`${b}=${f[b]}`);
          Ro = y;
...
`, "%p": (E) => 0 <= E.Sa && 12 > E.Sa ? "AM" : "PM", "%S": (E) => $(E.kb, 2), "%t": () => "	", "%u": (E) => E.Ma || 7, "%U": (E) => $(Math.floor((E.Qa + 7 - E.Ma) / 7), 2), "%V": (E) => {
      ...
      X.Va();
      var Td = [jr, _n, D, st, ze, P, pe, xe, Ft, Zr, ha, ma, ba, ga, ya, Ta, va, _a2, Ia, Sa, Aa, Pa, Ea, Da], xd = { b: function(f, b, y) {
    ...
    if (t > 0 && p.push(new Promise((d) => {
      ...
      if (r)
        if (v.numThreads = o, typeof Blob > "u")
          v.mainScriptUrlOrBlob = (void 0)(__dirname, "ort-wasm-threaded.js");
        else {
...
var Up = L(() => {
  ...
  Gp = (a) => {
    let t = De(), o = 0, e = [], r = a || {};
    try {
      if ((a == null ? void 0 : a.logSeverityLevel) === void 0)
      ...
      if ((a == null ? void 0 : a.logVerbosityLevel) === void 0)
      ...
      (a == null ? void 0 : a.terminate) === void 0 && (r.terminate = false);
      let n = 0;
      return (a == null ? void 0 : a.tag) !== void 0 && (n = ve(a.tag, e)), o = t._OrtCreateRunOptions(r.logSeverityLevel, r.logVerbosityLevel, !!r.terminate, n), o === 0 && _e("Can't create run options."), (a == null ? void 0 : a.extra) !== void 0 && bn(a.extra, "", /* @__PURE__ */ new WeakSet(), (s, i) => {
      ...
      switch (r) {
        case "webnn":
          if (r = "WEBNN", typeof e != "string") {
            ...
            if (s == null ? void 0 : s.powerPreference) {
...
var rd = L(() => {
  ...
  mg = (a, t) => {
    ...
    try {
      if ([s, u] = zp(t), (t == null ? void 0 : t.externalData) && r.mountExternalData) {
        let C = [];
      ...
      let [p, d] = bg(n), T = !!(t == null ? void 0 : t.enableGraphCapture), w = [], v = [], S = [];
      for (let C = 0; C < p; C++) {
    ...
    let [e, r, n, s, i] = o;
    s && (i && t._OrtClearBoundOutputs(s.handle), t._OrtReleaseBinding(s.handle)), (_a = t.jsepOnReleaseSession) == null ? void 0 : _a.call(t, a), r.forEach((u) => t._OrtFree(u)), n.forEach((u) => t._OrtFree(u)), t._OrtReleaseSession(e), zr.delete(a);
    ...
    try {
      ...
      for (let ee = 0; ee < v; ee++) {
        ...
        try {
          ...
          Re = Wp(qt);
          let tr = p == null ? void 0 : p.outputPreferredLocations[e[ee]];
          if (Re === "string") {
            if (tr === "gpu-buffer")
              throw new Error("String tensor is not supported on GPU.");
            let ke = [], Be = Ce / 4;
...
var da = L(() => {
  ...
  }, Eo = typeof document < "u" ? (_a = document == null ? void 0 : document.currentScript) == null ? void 0 : _a.src : void 0, od = async () => {
    if (!Do) {
      if (yn)
      ...
      if (yn = true, _r())
        return Z.wasm.wasmPaths === void 0 && Eo && Eo.indexOf("blob:") !== 0 && (Z.wasm.wasmPaths = Eo.substr(0, +Eo.lastIndexOf("/") + 1)), new Promise((a, t) => {
          gt == null ? void 0 : gt.terminate();
...
onnxruntime-web/dist/esm/ort.min.js:
  ...
  *)
*/
//# sourceMappingURL=ort.min-KC72N7DW.js.map
