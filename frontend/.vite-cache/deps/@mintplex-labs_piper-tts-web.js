...
var _TtsSession = class _TtsSession2 {
  ...
  async init() {
    const { createPiperPhonemize } = await import("./piper-o91UDS6e-P537QZPM.js");
    __privateSet(this, _createPiperPhonemize, createPiperPhonemize);
    __privateSet(this, _ort, await import("./ort.min-KC72N7DW.js"));
...
async function voices() {
  try {
    ...
    const LOCAL_VOICES_JSON = await import("./voices_static-D_OtJDHM-D4RV5WI5.js");
