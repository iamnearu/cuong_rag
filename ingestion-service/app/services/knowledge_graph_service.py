...
class KnowledgeGraphService:
    ...
    def __init__(
        ...
        self.kg_language = kg_language or settings.CUONGRAG_KG_LANGUAGE
        self.kg_entity_types = kg_entity_types or settings.CUONGRAG_KG_ENTITY_TYPES
        self._rag = None
    ...
    async def _get_rag(self):
        ...
        self._rag = LightRAG(
            ...
            chunk_token_size=settings.CUONGRAG_KG_CHUNK_TOKEN_SIZE,
            embedding_batch_num=max(1, settings.CUONGRAG_KG_EMBEDDING_BATCH_NUM),
            embedding_func_max_async=max(1, settings.CUONGRAG_KG_EMBEDDING_MAX_ASYNC),
            default_embedding_timeout=max(30, settings.CUONGRAG_KG_EMBEDDING_TIMEOUT_SECONDS),
            default_llm_timeout=max(60, settings.CUONGRAG_KG_LLM_TIMEOUT_SECONDS),
    ...
    async def query(
        ...
        try:
            ...
            logger.warning(
                f"KG query timed out after {settings.CUONGRAG_KG_QUERY_TIMEOUT}s "
