...
) -> "RAGService | CuongRAGService":
    """Factory function: routes to CuongRAGService or legacy RAGService based on config."""
    from app.core.config import settings

    if settings.CUONGRAG_ENABLED:
        from app.services.cuong_rag_service import CuongRAGService
        return CuongRAGService(
            db=db,
